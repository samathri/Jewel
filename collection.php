...
.add-to-cart:hover {
  ...
  color: #ffffff;
        ...
        .card-img-top {
            width: 100%;
            height: 300px; /* Default height for images */
            object-fit: cover;
        }
        ...
        @media (max-width: 576px) {
            ...
            .card-title {
                font-size: 18px; /* Make title font size smaller */
            }

            .card-text {
                font-size: 14px; /* Make text font size smaller */
            }
        }
    .search-form {
        display: flex;
...
/* Flexbox to align product name and heart icon */
.card-title {
    padding-left: 0px; /* Remove any default margin */
    font-size: 18px; /* Adjust the font size as needed */
}

/* Align heart icon to the right of product name */
.d-flex {
    display: flex;
...
.favorite-icon {
    font-size: 20px; /* Adjust the size of the heart icon */
...
$countSql = "
    SELECT 
        ...
        SUM(CASE WHEN category = 'Anklet' THEN 1 ELSE 0 END) AS Anklets_count,
        SUM(CASE WHEN category = 'Earring' THEN 1 ELSE 0 END) AS Earring_count,
  ...
  <body>
    ...
    <div class="title-with-lines">
        ...
        <div class="row">
            ...
            <!-- Results label -->
            <div class="col-12 col-md-4 text-center text-md-start mb-3 mb-md-0 mt-4">
    ...
    <div class="col-6"><label><span>(<?php echo $ringCount; ?>)</span></label></div>
</div>
<div class="row mt-2">
    <div class="col-6">
    ...
    <div class="col-6"><label><span>(<?php echo $PendantCount; ?>)</span></label></div>
</div>
<div class="row mt-2">
    <div class="col-6">
    ...
    <div class="col-6"><label><span>(<?php echo $AnkletsCount; ?>)</span></label></div>
</div>
<div class="row mt-2">
    <div class="col-6">
    ...
    <div class="col-6"><label><span>(<?php echo $EarringCount; ?>)</span></label></div>
</div>
<div class="row mt-2">
    <div class="col-6">
    ...
    <div class="col-6"><label><span>(<?php echo $Necklacecount; ?>)</span></label></div>
</div>
<div class="row mt-2">
    <div class="col-6">
    ...
    <div class="col-6"><label><span>(<?php echo $Charmscount; ?>)</span></label></div>
</div>
<div class="row mt-2">
    <div class="col-6">
    ...
    <div class="col-6"><label><span>(<?php echo $Broochescount; ?>)</span></label></div>
</div>
                        ...
                        <div class="card h-100" data-price="' . $Price . '">
                            ...
                            <div class="card-body text-right">
                             <p>' . $Gemstone . '</p>
                                ...
                                <form action="/Serandi/Serandi 2/addtocart.php" method="POST" style="display:inline;">
